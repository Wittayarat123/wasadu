          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped" style="width: 100%; height: 200px;">
                <thead>
                  <tr>
                    <th class="col-sm-4">ชื่อพัสดุ</th>
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                      ...
                      <td align="center"><?php echo $row["w_quantity"] ?> </td>
                      <td><?php echo $row["w_textcom"] ?> </td>
                      <td align="center">
                        <a href='cart.php?w_id=<?php echo $row["w_id"] ?>&act=add'>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <marquee direction="left">
                <h5 align='center' style="color: red;"><b>เบิกพัสดุแล้ว ไม่สามารถแก้ไขได้ กรุณาตรวจสอบการเบิกให้เรียบร้อย</b></h5>
              </marquee>
            </div>
          </div>
