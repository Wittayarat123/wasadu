          ...
          <ul class="navbar-nav ms-auto d-flex flex-row">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="profile.php"><i class='fas fa-user-alt'></i> ข้อมูลส่วนตัว</a>
                <?php
                if ($_SESSION["user_level"] == "admin") {
                ?>
                  <a class="dropdown-item" href="admin/dashboard.php"><i class='fas fa-home'></i> ระบบหลังบ้าน</a>
                <?php
                }
                ?>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="stock.php" class="nav-link" class="nav-link">
          ...
          if ($date1 >= $objResult123['start'] && $date1 <= $objResult123['end']) {
            ...
            echo "  <i class='nav-icon fas fa-cart-arrow-down'></i>";
            echo "  <p>เบิกพัสดุ</p>";
            echo " </a>";
            echo " </li>";
          } else {
            ...
            echo "  <i class='nav-icon fas fa-cart-arrow-down' style='color:red'></i>";
            echo "  <b style='color:red' font-weight: bold;>ยังไม่ถึงกำหนดเบิกพัสดุ</b>";
            echo " </a>";
            echo " </li>";
            // echo "เบิกไม่ได้";
            // echo "<div class='card-header'>";
            // echo "<div class='card'>";
            // echo "<h3 class='card-title'>ปฏิทิน</h3>";
            // echo "</div>";
          ...
          <li class="nav-item">
            <a href="history.php?user_id=<?php echo $result_tb_user["user_id"] ?>" class="nav-link">
