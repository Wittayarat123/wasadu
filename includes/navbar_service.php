...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="navbar-nav ms-auto d-flex flex-row">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                ?>
                  <a class="dropdown-item" href="../service_page/admin/admin.php"> <i class='fas fa-home'></i> ระบบหลังบ้าน</a>
                <?php
                }
                ?>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../homepage.php"><i class="fa fa-sign-out"></i> ออกจากระบบ</a>
              </div>
            </li>
          </ul>
        <?php
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../homepage.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">ระบบลาออนไลน์</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="history_service_el.php?user_id=<?php echo $result_tb_user["user_id"] ?>" class="nav-link">
