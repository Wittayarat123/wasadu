...
if (isset($_POST["submit"])) {
  ...
  if ($objResult) {
    ...
    $strSQL = "INSERT INTO tb_user (user_username,user_password,user_name,user_surname,user_sex,user_email,a_id,user_level,position) 
    VALUES (
            '" . $_POST["user_username"] . "',
