            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">รายการสต๊อก</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">รายการสต๊อก</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="panel-body mb-3" id="hid">
                                <form id="form1" name="form1" class="form-inline" method="post" action="stock_1.php">
                                    &nbsp;
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered mt-3" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT w.w_id, w.w_name, c.c_name, w.w_price, w.w_quantity,SUM(w.w_price*w.w_quantity) AS cc 
                                                    FROM tb_wasadu w
                                                    LEFT JOIN tb_count c ON c.c_id = w.c_id
                                                    WHERE w_quantity > '0' AND w_type = '$w_type'
                                                    GROUP BY w.w_id";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td align="center"><?php echo $objResult['w_quantity']; ?></td>
                                                    <td align="center"><?php echo number_format($objResult['cc'], 2); ?></td>
                                                </tr>
                                            <?php } ?>
