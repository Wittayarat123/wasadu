...
// คำนวณสต็อกใหม่
$new_stock1 = $current_stock1 - $d_spend;
...
// // ดึงข้อมูลสต็อกปัจจุบันของพัสดุ
// $current_stock_query = "SELECT o_id, d_id, d_spend FROM order_detail WHERE o_id = $o_id AND d_id = $d_id ";
...
// $current_stock = $current_stock_row['d_spend'];

// // คำนวณสต็อกใหม่
// $new_stock = $current_stock - $d_spend;
